    ...
    <nav className="w-full h-24 bg-white">
      <ul className="flex w-full h-full">
        <li className="w-[50%] lg:w-[20%] h-full flex items-center pl-12">
          <BsFillMouseFill className="text-[50px] text-black" />
          <h1 className="text-black text-[26px] ml-3 font-[600]">Younes</h1>
        </li>
        <li className="flex w-[50%]  h-full  lg:hidden justify-end items-center mr-10 bg-white">
          <div>
            <AppBar position="static" background="none" className=" bg-white">
              <Toolbar className="bg-white text-[#77797B]">
                <IconButton
                  className="bg-[#111518]"
                  color="inherit"
                  aria-label="menu"
        ...
        <li className="text-white hidden lg:flex lg:w-[70%] pl-12 h-full">
          <ul className="flex w-full h-full justify-center items-center gap-12">
            {menuItems.map((val, i) => {
              return (
                <li
                  className="flex justify-center text-[#797B7C] font-semibold hover:text-[#4928CF] transition-all duration-500 cursor-pointer items-center h-full"
                  key={i}
                >
                  {val.name}
                </li>
        ...
        <li className="hidden lg:flex w-[33%] h-full text-[#797B7C] justify-center items-center gap-8">
          <SearchIcon className="hover:text-[#4928CF] transition-all duration-500 cursor-pointer"></SearchIcon>
          <PersonOutlineIcon className="hover:text-[#4928CF] transition-all duration-500 cursor-pointer"></PersonOutlineIcon>
          <AddShoppingCartIcon className="hover:text-[#4928CF] transition-all duration-500 cursor-pointer">
          </AddShoppingCartIcon>
          <Link href="../basket">
